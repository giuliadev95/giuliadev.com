...
export default function Hero() {
    return(
        <div className="flex flex-col items-center justify-center mt-8 md:mt-12 lg:mt-16 xxl:mt-24 gap-8 mx-8">
            ...
            websites, focusing on accessibility and
            user experience.
            </p>   
            ...
            <span className="flex justify-between items-center gap-24">
                ...
                <Link href={"/"}  aria-label="Go to my projects" title="Go to my projects" className="bg-green rounded-2xl px-4 py-2 flex items-center justify-center gap-1 w-[100px] transition-all duration-300 hover:scale-110">
                    <p className="text-background text-sm font-medium">
                        Projects
                    </p>
