...
export default function Hero() {
    return(
        <div className="flex flex-col items-center justify-center mt-8 md:mt-12 lg:mt-16 xxl:mt-24 gap-8 mx-8">
            {/* Hi, I'm Giulia 👋, Web Developer */}
            <h1 className="text-white text-4xl md:text-5xl drop-shadow-md font-medium flex flex-col justify-center items-center gap-1">Ciao, sono Giulia
            ...
            1 anno di esperienza in programmazione
            Front End e Back End, passione per UX e UI design
            </p>         
