...
export default function Contact() {
  return (
    <section
      className="bg-white px-4 lg:px-16 xl:px-64 py-8 flex flex-col items-start justify-start gap-4 mt-12 scroll-mt-20 max-w-[100rem]"
      id="contact"
    >
      {/** Title */}
      ...
      <p className="text-base md:text-lg font-normal text-lightGrey leading-relaxed">
        Cerchi collaborazioni per un un progetto? Mi piacerebbe entrare nel tuo
        team!
      </p>

      <a
        href="mailto:giuliadev95@gmail.com"
        className="hover:underline text-base md:text-lg font-bold text-lightGrey"
      >
        Contattami via mail 📩
      </a>
      ...
      <ul className="flex justify-start items-start gap-[2rem]">
        ...
        <li>
          <a
            ...
            className="hover:underline text-base md:text-lg font-bold text-lightGrey flex-col items-center"
          >
            Scopri i miei progetti su GitHub:
            <FaGithub
              className="text-lightGreen font-semibold text-[3rem] border border-white rounded-2xl bg-white"
              size={"30px"}
            />
